...
gsap.from('.main-name', { duration: 1.5, delay: .9, stagger: .6, x: '-100vw', ease: 'power2.in', opacity: 0 });
gsap.from('.dopuslugi', { duration: 1, delay: .1, stagger: .6, x: '-100vw', ease: 'power2.in', opacity: 0 });
gsap.from(".tour", {opacity: 0, duration: 1.4, delay: 1, stagger: .3});
gsap.from(".nav-item", {opacity: 0, duration: 2, delay: 1, stagger: 0.6 });
